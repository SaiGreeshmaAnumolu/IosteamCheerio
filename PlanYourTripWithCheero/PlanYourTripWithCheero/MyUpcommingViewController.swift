//
//  MyUpcommingViewController.swift
...
class MyUpcommingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var dataTV: UITableView!
    
    let database = Firestore.firestore()
    
    var UpcommingList: [HistoryModel] = []
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Upcomming Tours"
            ...
            if let err = err {
                ...
                for record in self.allRecords {
                    ...
                    if date > Date() {
                        ...
                        self.UpcommingList.append(record)
                    }
                }
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: UpcommingTVC! = tableView.dequeueReusableCell(withIdentifier: "UpcommingCell") as? UpcommingTVC
        
        let iten = self.UpcommingList[indexPath.row]
